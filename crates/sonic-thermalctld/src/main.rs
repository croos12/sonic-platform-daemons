...
use sonic_thermalctld::chassis::Chassis;
use sonic_thermalctld::monitor::ThermalMonitor;
use sonic_thermalctld::policy::ThermalPolicyManager;
...
async fn main() -> Result<()> {
    ...
    let chassis = {
        ...
        {
            use sonic_thermalctld::platforms::mellanox;
